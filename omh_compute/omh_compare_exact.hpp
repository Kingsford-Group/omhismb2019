...
#ifndef __OMH_COMPARE_EXACT_HPP__
#define __OMH_COMPARE_EXACT_HPP__
...
public:
  ...
  omh_compare_exact(int argc, char* argv[]) :
    k_arg((uint32_t)5), k_given(false),
    l_arg((uint32_t)2), l_given(false),
    rc_flag(false),
    seq1_arg(""),
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    ...
    seq1_arg = argv[optind];
    ++optind;
    seq2_arg = argv[optind];
    ++optind;
  }
  static const char * usage() { return "Usage: omh_compare_exact [options] seq1:PATH seq2:PATH"; }
  class error {
    int code_;
...
#endif // __OMH_COMPARE_EXACT_HPP__"
