...
#ifndef __OMH_COMPARE_SKETCH_HPP__
#define __OMH_COMPARE_SKETCH_HPP__
...
public:
  ...
  omh_compare_sketch() :
    m_arg(0), m_given(false),
    circular_flag(false),
    sk1_arg(""),
    sk2_arg("")
  { }

  omh_compare_sketch(int argc, char* argv[]) :
    m_arg(0), m_given(false),
    circular_flag(false),
    sk1_arg(""),
    sk2_arg("")
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUm:c";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'm':
        m_given = true;
        m_arg = conv_int<int32_t>((const char*)optarg, err, false);
        CHECK_ERR(int32_t, optarg, "-m")
        break;
      case 'c':
        circular_flag = true;
        break;
  ...
  static const char * usage() { return "Usage: omh_compare_sketch [options] sk1:PATH sk2:PATH"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    ...
    " -m                                       Compare only m first entries\n"
    " -c, --circular                           Sketch of a circular genome (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "circular_flag:" << circular_flag << "\n";
    os << "sk1_arg:" << sk1_arg << "\n";
    os << "sk2_arg:" << sk2_arg << "\n";
  }
};
#endif // __OMH_COMPARE_SKETCH_HPP__"
