...
#ifndef __OMH_COMPARE_EXACT_SEQ_HPP__
#define __OMH_COMPARE_EXACT_SEQ_HPP__
...
public:
  ...
  omh_compare_exact_seq(int argc, char* argv[]) :
    k_arg((uint32_t)5), k_given(false),
    l_arg((uint32_t)2), l_given(false),
    rc_flag(false),
    seq1_arg(""),
  ...
  void parse(int argc, char* argv[]) {
    ...
    static const char *short_options = "hVUk:l:";
...
#define CHECK_ERR(type,val,which) if(!err.empty()) { ::std::cerr << "Invalid " #type " '" << val << "' for [" which "]: " << err << "\n"; exit(1); }
    while(true) {
      ...
      case 'k':
        k_given = true;
        k_arg = conv_uint<uint32_t>((const char*)optarg, err, false);
    ...
    seq1_arg = string(argv[optind]);
    ++optind;
    seq2_arg = string(argv[optind]);
    ++optind;
  }
  static const char * usage() { return "Usage: omh_compare_exact_seq [options] seq1:SEQUENCE seq2:SEQUENCE"; }
  class error {
    int code_;
  ...
  static const char * help() { return
    "Compare sequences using exact OMH\n\n"
    "Options (default value in (), *required):\n"
    " -k                                       Length of k-mer (5)\n"
    " -l                                       Length of vector IGNORED. FIX to 2 (2)\n"
    "     --rc                                 Consider reverse complement (false)\n"
    " -U, --usage                              Usage\n"
    " -h, --help                               This message\n"
    " -V, --version                            Version";
  }
...
#define PACKAGE_VERSION "0.0.0"
  ...
  void dump(::std::ostream &os = std::cout) {
    ...
    os << "rc_flag:" << rc_flag << "\n";
    os << "seq1_arg:" << seq1_arg << "\n";
    os << "seq2_arg:" << seq2_arg << "\n";
  }
};
#endif // __OMH_COMPARE_EXACT_SEQ_HPP__"
